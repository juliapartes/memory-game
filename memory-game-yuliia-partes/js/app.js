...
const allCards = ["fa-diamond", "fa-paper-plane-o", "fa-anchor", "fa-bolt", 
...
If they are, the function stop the timer and shows to uder his score */


function win() {
	if(matchedList.length === 16) {
		stopTimer();
		alert("You win! Score: " + moves/2 + " Time: " + formatTime() 
